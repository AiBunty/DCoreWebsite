...
export default function Legal() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-slide-up" style={{ animationDelay: '100ms', animationFillMode: 'both' }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/70 border border-gray-200/50 mb-8 backdrop-blur-xl shadow-sm">
                ...
                <span className="text-sm font-semibold tracking-tight text-gray-800">Disclaimer</span>
              </div>
            </div>
  ...
  <p>This disclaimer outlines important limitations on our liability.</p>
  
  <div>
    <h2 className="text-2xl font-bold text-gray-900 mb-4">1. As-Is Provision</h2>
    <p>The Dcore Systems platform is provided "as-is" without express or implied warranties.</p>
  </div>
  
  <div>
    <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Limitation of Liability</h2>
    <p>Dcore Systems is not liable for indirect, incidental, special, or consequential damages arising from platform use.</p>
  </div>
  
  <div>
    <h2 className="text-2xl font-bold text-gray-900 mb-4">3. User Responsibility</h2>
    <p>You are responsible for maintaining data backups and data security practices.</p>
  </div>
  
  <div>
    <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Accuracy</h2>
    <p>While we strive for accuracy, we make no guarantees about platform information completeness.</p>
  </div>
