  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              Dcore Systems for Fitness Clubs
            </h1>
            <p className="text-xl text-muted-foreground mb-8">
              Convert more trials, retain more members, and grow your fitness business.
            </p>
            <Button variant="hero" size="xl" asChild>
              <Link to="/book-demo">Increase Membership Conversions with Dcore Systems</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <CTASection 
        ...
        ctaText="Increase Membership Conversions with Dcore Systems"
      />
    </Layout>
  );
}
